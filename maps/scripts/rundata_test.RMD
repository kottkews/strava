...
rundata <- jsonlite::read_json("C:/Users/shelb/Documents/shelbykottkeweaver@gmail.com_0_summarizedActivities.json",
                                 simplifyVector = TRUE)
...
final_mapdata <- st_join(rundata_sf, usa_df)
